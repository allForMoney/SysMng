...
public class Budgetauditlog {
  ...
  @Basic
  @Column(name = "AdjudstId", nullable = false, length = 20)
  public String getAdjudstId() {
    return adjudstId;
  }

  public void setAdjudstId(String adjudstId) {
    this.adjudstId = adjudstId;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (adjudstId != null ? !adjudstId.equals(that.adjudstId) : that.adjudstId != null) return false;
  ...
  public int hashCode() {
    ...
    result = 31 * result + (adjudstId != null ? adjudstId.hashCode() : 0);
