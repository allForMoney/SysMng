...
(
   ...
   FINACE_HEADER_TEL    VARCHAR(100) NOT NULL COMMENT '财务电话',
   FINACE_HEADER_QQ     VARCHAR(50) DEFAULT NULL COMMENT '财务QQ',
   PROJECT_HEADER       VARCHAR(50) NOT NULL COMMENT '项目负责人',
   PROJECT_HEADER_TEL   VARCHAR(100) NOT NULL COMMENT '项目负责人电话',
   REPORTER             VARCHAR(50) NOT NULL COMMENT '填报人',
   REPORTER_TEL         VARCHAR(100) NOT NULL COMMENT '填报人电话',
...
(
   ...
   TELEPHONE_NUM        VARCHAR(100) DEFAULT NULL COMMENT '电话',
